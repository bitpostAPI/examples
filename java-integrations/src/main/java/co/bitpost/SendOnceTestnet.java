...
public class SendOnceTestnet {

    static Logger LOGGER = LoggerFactory.getLogger(SendOnceTestnet.class);

    static long satsToSend = 1_000;
    static int maxDollarFee = 3;
    static Address destination = Address.fromString(TestNet3Params.get(), "mk68e6JzRX8ZFY3Jtv2Fv1RijnmuDTJXuK");
